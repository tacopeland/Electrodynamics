...
import electrodynamics.core.common.utility.PlayerUtilities;
...
public class PacketHandler {
	...
	public static EntityPlayer getPlayer(MessageContext context) {
		return Electrodynamics.proxy.getPlayer(context);
	}
	...
	public static void writeObject(Object object, ByteBuf dataStream) {
		try {
			...
			Electrodynamics.logger.error("An error occurred when sending packet data.");
			e.printStackTrace();
		}
	}
